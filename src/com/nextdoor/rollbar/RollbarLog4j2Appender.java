...
@Plugin(name = "NoeticRollbar", category = "Core", elementType = "appender", printObject = true)
public class RollbarLog4j2Appender extends AbstractAppender {
    
    private static final long serialVersionUID = 3158165211231748627L;
    
    public Rollbar client = null;
    ...
    public static RollbarLog4j2Appender createAppender(@PluginAttribute("name") String name,
            ...
            @PluginElement("Filter") final Filter filter, @PluginAttribute("accessToken") String accessToken,
